...
function generate_textloop() {
    
    textloop = ""
    input_text = textfield_textloop.value;
    input_loopint = textfield_loopint.value;
    for (let i = 0; i < input_loopint; i++) {
        textloop += input_text;
    }
    
    clipstock2.style.display = "block";
    clipstock2.value = textloop;
    copy('clipstock2');
    clipstock2.style.display = "none";
    alert("Cliped : " + textloop)
}
